...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'La autenticación de dos factores ya está activa. Escanea el código QR o ingresa la clave en tu aplicación autenticadora.',
            buttonText: 'Cerrar',
        };
    }
    ...
    return {
        ...
        description:
            'Para terminar de activar el 2FA, escanea el código QR o ingresa la clave en tu aplicación autenticadora',
        buttonText: 'Continuar',
    };
});
                ...
                <template v-if="!showVerificationStep">
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            />
                            <span class="relative bg-card px-2 py-1">o ingresa el código manualmente</span>
                        </div>
