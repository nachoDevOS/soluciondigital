    ...
    <div v-if="canManageTwoFactor" class="space-y-6">
        ...
        <div v-if="!twoFactorEnabled" class="flex flex-col items-start justify-start space-y-4">
            <p class="text-sm text-muted-foreground">
                Al activar la autenticación de dos factores, se te pedirá un código seguro al iniciar sesión. Este código lo obtendrás desde una aplicación TOTP en tu teléfono.
            </p>
        ...
        <div v-else class="flex flex-col items-start justify-start space-y-4">
            <p class="text-sm text-muted-foreground">
                Se te pedirá un código seguro al iniciar sesión, el cual podrás obtener desde la aplicación TOTP en tu teléfono.
            </p>
